...
const AnodiamForgetPassword = () => {
  ...
  return (
    <>
      <PageHeading heading='Change / Forget Password' />
      <div className="anodiam-body-panel-mid">
        <form className="anodiam-form" onSubmit={handleSubmit}>
          <div className="container anodiam-container">
            ...
            { !isPending && <button className="btn btn-primary btn-block">Change Password</button> }
            { isPending && <button disabled className="btn btn-primary btn-block btn-disabled">
              Changing Password for {firstName}...</button> }
          </div>
        </form>
      </div>
      <AskForLogin />
...
export default AnodiamForgetPassword;